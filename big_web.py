...
def main():
    ...
    with st.sidebar:
        ...
        neo4j_uri = st.text_input("Neo4j URI", value="bolt://localhost:7687", key="neo4j_uri")
        neo4j_user = st.text_input("Neo4j Username", value="neo4j", key="neo4j_user")
        neo4j_password = st.text_input("Neo4j Password", type="password", value="12345678", key="neo4j_password")
        ...
        mongodb_uri = st.text_input("MongoDB URI", value="mongodb://localhost:27017/", key="mongodb_uri")
        mongodb_db = st.text_input("Database Name", value="wikimultihop_db", key="mongodb_db")
